    ...
    const fetchBackground = async () => {
      try {
        ...
        const defaultFrame = [
          {
            id: 0,
            name: t("settings.camera_background.none"),
            url: null,
          },
        ];
        setBackgroundState([
        ...
        const defaultFrame = [
          ...
          {
            id: 1,
            name: t("settings.camera_background.coming_soon"),
            url: null,
          },
        ];
    ...
    <div className="w-full flex justify-center overflow-hidden">
      <div className="h-full max-w-md">
        <h1 className="font-lovehouse text-base-content text-center text-3xl font-semibold">
          {t("settings.camera_background.title")}
        </h1>
          ...
          {backgrounds.map((bg) => {
            ...
            return (
              <SwiperSlide key={bg.id}>
                ...
                >
                  {bg?.name || t("settings.camera_background.none")}
                </div>
              </SwiperSlide>
            );
          })}
