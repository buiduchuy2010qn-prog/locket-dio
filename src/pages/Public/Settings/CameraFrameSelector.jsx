  ...
  useEffect(() => {
    const fetchFrames = async () => {
      try {
        ...
        const defaultFrame = { id: 0, name: t("settings.camera_frame.none"), imageSrc: null };
        ...
        setFrames([{ id: 0, name: t("settings.camera_frame.none"), imageSrc: null }]);
      }
    };
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center mb-4 text-base-content">
        ...
        <h2 className="text-lg font-semibold">{t("settings.camera_frame.title")}</h2>
      </div>
      ...
      <div className="text-center mb-4">
        <span className="text-sm font-medium text-base-content/80">
          {cameraFrame?.name || t("settings.camera_frame.no_frame_selected")}
        </span>
      </div>
