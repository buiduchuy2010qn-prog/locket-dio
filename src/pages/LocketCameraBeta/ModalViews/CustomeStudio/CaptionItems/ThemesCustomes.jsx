    ...
    <div className="px-4">
      ...
      <div className="flex flex-wrap gap-3 pt-2 pb-5 justify-start">
        {isLoading ? (
          ...
          list.map((preset) => {
            const top = preset.top || preset.color_top || "#444";
            const bot = preset.color_bot || preset.color_bottom || "#222";
            const textColor =
              preset.color_text || preset.text_color || "#FFFFFF";
            const label =
              preset.caption || preset.preset_caption || "Aa";
            const applyCaption =
              preset.apply_caption !== undefined
                ? preset.apply_caption
                : label;
            ...
            return (
              <button
                ...
                type="button"
                className="flex flex-row whitespace-nowrap items-center gap-1.5 py-2 px-4 btn h-auto w-auto rounded-3xl font-semibold justify-center shadow-sm border-0 active:scale-95 transition"
                style={{
