  ...
  return (
    <div className="">
      <div className="flex w-full items-end gap-3 px-4 py-3.5 bg-base-200 rounded-3xl shadow-md relative">
        <textarea
          ref={textareaRef}
          placeholder={t("right.send_message_placeholder")}
          value={message}
          onChange={handleChange}
          rows={1}
          className="flex-1 bg-transparent focus:outline-none font-semibold pl-1 pr-7 resize-none disabled:opacity-50 leading-6 overflow-y-auto placeholder:opacity-70"
          disabled={loading}
        />
        <button
          onClick={handleSend}
