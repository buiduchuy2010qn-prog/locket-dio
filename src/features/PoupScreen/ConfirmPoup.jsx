...
const ConfirmPoup = ({
  ...
  const resolvedLabelConfirm = labelConfirm ?? t("confirm_poup.confirm_btn");
  const resolvedLoadingText = loadingText ?? t("confirm_poup.loading_text");
