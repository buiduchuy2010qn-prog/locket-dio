...
export const config = {
  ...
  freeVideoMaxSec: Number(process.env.FREE_VIDEO_MAX_SEC || 60),
  goldVideoMaxSec: Number(process.env.GOLD_VIDEO_MAX_SEC || 60),
  freeMaxUploadMb: Number(process.env.FREE_MAX_UPLOAD_MB || 50),
