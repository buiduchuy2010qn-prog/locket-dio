...
export const config = {
  ...
  freeFriendLimit: Number(process.env.FREE_FRIEND_LIMIT || 5),
  freeVideoMaxSec: Number(process.env.FREE_VIDEO_MAX_SEC || 5),
  goldVideoMaxSec: Number(process.env.GOLD_VIDEO_MAX_SEC || 30),
  freeMaxUploadMb: Number(process.env.FREE_MAX_UPLOAD_MB || 8),
  goldMaxUploadMb: Number(process.env.GOLD_MAX_UPLOAD_MB || 50),
  cloudinary: {
