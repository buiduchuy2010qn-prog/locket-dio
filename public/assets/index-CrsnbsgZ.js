import{g as Q}from"./ai-enhance-local-DNlsMot6.js";import{a as U}from"./react-DoXPzv6d.js";var g={},z;function V(){if(z)return g;z=1;function A(r){if(typeof window>"u")return;const u=document.createElement("style");return u.setAttribute("type","text/css"),u.innerHTML=r,document.head.appendChild(u),r}Object.defineProperty(g,"__esModule",{value:!0});var e=U();function D(r){return r&&typeof r=="object"&&"default"in r?r:{default:r}}var a=D(e);A(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;
